...
Worked end-to-end examples: [[file:tutorial.org][Tutorial]]. Module architecture: [[file:architecture.org][Architecture]]. Full procedure tables: [[file:reference.org][API reference]].
