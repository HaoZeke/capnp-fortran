...
| Goal | Go to |
|------+-------|
| Install fpm / pixi and build the suite | [[file:install.org][Install]] |
| Write and read a message from a =.capnp= schema | [[file:tutorial.org][Tutorial]] |
| Generate modules with =capnpc-fortran= | [[file:codegen.org][Code generation]] |
| Call a capability over a socket | [[file:tutorial.org][Tutorial (RPC section)]] + [[file:rpc.org][RPC]] |
| Byte-compatible with c-capnproto / C++ | [[file:interop.org][Interop]] |
| Full procedure list | [[file:reference.org][API reference]] |

* Install (shortest path)

With [[https://fpm.fortran-lang.org][fpm]] and a recent gfortran:
...
The plugin binary lands under =build/gfortran_*/app/capnpc-fortran=. Details, codegen, and interop builds: [[file:install.org][Install]].
...
- *C ABI*: =capnp_cabi= + cmocka golden master vs [[https://github.com/opensourcerouting/c-capnproto][c-capnproto]]
