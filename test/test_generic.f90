...
program test_generic
   ...
   call check_(err == CAPNP_OK, 'generic: branded element list init')
   ...
   call check_(err == CAPNP_OK, 'generic: branded element set')
   ...
   call check_(err == CAPNP_OK, 'generic: list-binding value set')
   ...
   call check_(err == CAPNP_OK, 'generic: nested brand set')
